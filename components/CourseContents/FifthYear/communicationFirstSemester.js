import { FirstElectiveTable, FirstSemesterTable } from "./communicationTable";
    ...
    <article className="max-w-full mx-auto w-inner-width padding">
      <div className="bg-white w-full p-[50px] rounded-2xl border border-primary-stroke">
        ...
        <p className="text-sm mt-[100px]">
          ...
          societal impact.
          <br /> <br />
          <strong>CCE516: OPTICAL COMMUNICATION SYSTEMS (2 UNITS)</strong>
          <br />
          Optical transmitting devices, LEDs optical receivers, optical
          fibres/types, features, joining, couphing/deep space communication
          system/capacity, reliability economy/application of PCM and ADPCM
          concepts.
          <br /> <br />
          <strong>CCE517: SATELLITE COMMUNICATION (2 UNITS)</strong> <br />
          Brief history and overview of Satellite Communications.Orbital
          Mechanics.Satellite Subsystems.Satellite Link Design. Modulation &
          Multiplexing Techniques used in Satcom. Multiple Access Techniques.
          Error Correction for Digital Satellite Links. Propagation Effects and
          their Impact on Satellite Links.VSAT Systems.LEOs and
          Non-Geostationary Satellite Systems.DBS TV and Radio. Satellite
          Navigation and the Global Positioning System
          <br /> <br />
          <strong>CE518: WIRELESS AND MOBILE COMMUNICATION (3 UNITS)</strong>
          <br />
          ...
          Frequency reuse, Roaming, Hand-off strategies, Co-channel
          interference, Traffic and Grade of service, System capacity, Improving
          capacity of cellular system. Propagation path loss, multipath
          propagation problem, Raleigh fading, Rician distribution. Doppler
          effect. Field strength prediction models, co-channel interference and
          reduction, adjacent channel interference, near-far problem. <br />
          Standards and overview of analogue and digital cellular systems: AMPS,
          TACS, GSM, CT2, PCN, DECT, PHS. Frequency management and channel
          assignment, speech coding, channel coding, bandwidth consideration,
          equalization, modulation techniques, multiple access techniques. GSM:
          Architecture, elements, and standard interfaces; FDMA/TDMA structure;
          Speech and channel coding ; time slots and bursts; signaling;
          hand-offs; DCS 1800; GPRS; data services over gsm. Third Generation
          Wireless Standard: convergence; UMTS; IMT-2000; CDMA2000; W-CDMA;
          UWC-136; Network layer standards. Paging services and technologies;
          Short Message Services. Call Processing: Signaling; Roaming and
          mobility management; Route optimization; Wireless Intelligent
          Networking; Databases; Protocols; Security and billing issues. Global
          ...
          <br /> <br />
          <strong>EE508: MICROWAVE ENGINEERING (3 UNITS)</strong> <br />
          Microwave frequencies and uses; microwave transmission in transmission
          lines and waveguides, microwave circuits, impedance transformation and
          matching, passive microwave devices, resonant and filter circuits,
          active microwave devices; Klystron, and magnetron tubes and
          semi-conductor devices for microwave generation.  Antennae:
          definitions of elementary parameters related to radiation patterns;
          dipole and aperture antennae and the related design parameters;
          introduction to antenna arrays.  Radio wave propagation: propagation
          in the ionosphere, troposphere and in stratified media; principles of
          scatter propagation; applications in general broadcast, television and
          satellite communication systems.  Radar Systems: Nature of radar and
          radar equations; composition of a radar system; application of
          different types of radars.
          <br /> <br />
          <strong>EE509: MICROWAVE ENGINEERING LABORATORY (1 UNIT)</strong>
          <br />
          A laboratory on microwave engineering designed to illustrate topics
          covered in EE508.
          <br /> <br />
          <strong>
...
export default CommunicationFirstSemester;
